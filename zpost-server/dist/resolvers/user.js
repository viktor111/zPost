...
let UserResolver = class UserResolver {
    ...
    register(options, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userExist = em.findOne(User_1.Users, { username: options.username });
            if (!userExist) {
                return {
                    errors: [{
                            field: "username",
    ...
    login(options, { em, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield em.findOne(User_1.Users, { username: options.username });
            if (!user) {
                return {
                    errors: [{
                            field: 'username',
